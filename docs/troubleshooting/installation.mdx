...
* **Fix**: Compile and install GLibC `>=2.29`. However, if users want a faster hotfix. Please follow the follwing instructions.
...
* **Fix**: Install `mpegCoder` from PyPI, or download our dependencies.
