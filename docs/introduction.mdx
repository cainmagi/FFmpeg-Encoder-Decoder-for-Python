...
<p>
  <DarkButton to="https://github.com/cainmagi/FFmpeg-Encoder-Decoder-for-Python/blob/main/CONTRIBUTING.md" icon={octRepoForked16}>
    Contributions
  </DarkButton>
</p>
...
<p>
  <DarkButton to="https://github.com/cainmagi/FFmpeg-Encoder-Decoder-for-Python/blob/main/CODE_OF_CONDUCT.md" icon={octShareAndroid16}>
    Code of Conduct
  </DarkButton>
</p>
