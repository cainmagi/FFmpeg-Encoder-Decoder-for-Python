...
<p>
  ...
  <Splitter />
  <SourceURL ver="3.1.0" url="MpegStreamer.h#L49">
...
Set the configurations of the client. To make the configurations take effects, these parameters need to be configured before [`FFmpegSetup()`](#ffmpegsetup).
...
### Configure the cache size {#configure-the-cache-size}
